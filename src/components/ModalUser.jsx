function ModalUser() {
	...
	return (
		<>
			<div
				id="modal-user"
				className="bg-[#343b40] bg-opacity-90 absolute right-4 rounded-xl border border-[#E5e5e5] p-[0.5rem]"
			>
				<div className="hover:bg-[#2e2e2e] cursor-pointer rounded-xl p-[0.5rem] my-[1rem] flex items-center">
